<template>
  <div class='menu'>
    ...
    <mj_menu_dialog :title="title" :dialogStatus="dialogStatus" :userId="userId" @changeDialogStatus="changeDialogStatus" @userList="userList"></mj_menu_dialog>
  </div>
