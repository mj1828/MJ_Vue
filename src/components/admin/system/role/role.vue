<template>
  <div class='role'>
    ...
    <mj_role_dialog :title="title" :dialogStatus="dialogStatus" :userId="userId" @changeDialogStatus="changeDialogStatus" @userList="userList"></mj_role_dialog>
  </div>
